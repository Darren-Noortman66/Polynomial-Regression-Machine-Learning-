...
# ABHISHEK SHARMA(2020) - Introduction to Polynomial Regression (with Python Implementation) - analytics vidhya, retrieved 25 July 2021 from
# https://www.analyticsvidhya.com/blog/2020/03/polynomial-regression-python/

# Previous Tasks on this level

# Reading piece and example given in this tas file.
